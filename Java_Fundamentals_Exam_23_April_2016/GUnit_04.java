package JAVA_DEVELOPMENT_SOFTUNI.Java_Development.Java_Advanced.Archive.Advanced_Java.Advanced_Java_Exams.Java_Fundamentals_Exam_23_April_2016;
...
public class GUnit_04 {
    public static void main(String[] args) {
        ...
        LinkedHashMap<String, LinkedHashMap<String, ArrayList<String>>> sortedClasses =
                classesDatabase
                        ...
                        .sorted((firstClass, secondClass) -> {
                            ...
                            Integer result = Integer.valueOf(GUnit_04.getAllUnitTests(secondClass.getValue().values())
                                            .size())
                                    .compareTo(Integer.valueOf(GUnit_04.getAllUnitTests(firstClass.getValue().values())
                                            .size()));
        ...
        for (Map.Entry<String, LinkedHashMap<String, ArrayList<String>>> entryClass : sortedClasses.entrySet()) {
            ...
            for(Map.Entry<String, ArrayList<String>> entryMethod : sortedMethods.entrySet()){
